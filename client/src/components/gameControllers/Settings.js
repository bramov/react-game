    ...
    <>
      <div className="nav-wrapper">
        <ul className="left settings-left">
          ...
          <li><button className="btn btn-icon"><i className="material-icons">autorenew</i></button></li>
          <li><button className="btn btn-icon"><i className="material-icons">burst_mode</i></button></li>
        </ul>
